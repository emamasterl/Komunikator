...
def print_out(question, response):
    ...
    fileName=r'C:\Users\emama\OneDrive\Documents\Coding\Seca projekt\Komunikator-main\app\intents2.json'
...
def get_response(text):
    ...
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r'C:\Users\emama\OneDrive\Documents\Coding\Seca projekt\Komunikator-main\app\vaja-stqi-a94d4033cbd5.json'
