...
def extractPlacesFrom(text):
    #print("\nInput: "+text)
    API_KEY = 'AIzaSyD9vbHLaeqQH8n_DXGeVJVeC3guU40_H4A'
...
def get_response(text):
    ...
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r'.\vaja-stqi-0bdf0684930b.json'
...
def talk_back(question):
    ...
    try:
        ...
        log.warning("Neuspesna razpoznava govora")
